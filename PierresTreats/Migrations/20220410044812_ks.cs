    ...
    public partial class ks : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PierresTreats", x => x.FlavorTreatId);
                    table.ForeignKey(
                        name: "FK_PierresTreats_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PierresTreats_Flavors_FlavorId",
                        column: x => x.FlavorId,
                        principalTable: "Flavors",
                        principalColumn: "FlavorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PierresTreats_Treats_TreatId",
                        column: x => x.TreatId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PierresTreats_FlavorId",
                table: "PierresTreats",
                column: "FlavorId");

            migrationBuilder.CreateIndex(
                name: "IX_PierresTreats_TreatId",
                table: "PierresTreats",
                column: "TreatId");

            migrationBuilder.CreateIndex(
                name: "IX_PierresTreats_UserId",
                table: "PierresTreats",
                column: "UserId");
